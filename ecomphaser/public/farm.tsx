...
<tileset version="1.10" tiledversion="1.11.2" name="farm" tilewidth="16" tileheight="16" tilecount="9" columns="3">
 <image source="Downloads/Cute_Fantasy_Free/Cute_Fantasy_Free/Tiles/FarmLand_Tile.png" width="48" height="48"/>
 <wangsets>
  <wangset name="Unnamed Set" type="corner" tile="-1">
   ...
   <wangtile tileid="6" wangid="0,1,0,2,0,2,0,2"/>
